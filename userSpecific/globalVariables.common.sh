...
# repository
	...
	# nasm http://www.nasm.us/
		_NASM_SOURCE_FILENAME=nasm-2.13.01
	...
	# boost http://www.boost.org/
		# _BOOST_SOURCE_FILENAME=boost_1_64_0
		_BOOST_SOURCE_FILENAME=boost_1_63_0
		_BOOST_SOURCE=$_REPOSITORY_DIR/boost/$_BOOST_SOURCE_FILENAME.7z
		
	# gdcm https://sourceforge.net/projects/gdcm/
		# _GDCM_SOURCE_FILENAME=gdcm-2.8.2
		_GDCM_SOURCE_FILENAME=gdcm-2.8.0
		_GDCM_SOURCE=$_REPOSITORY_DIR/gdcm/$_GDCM_SOURCE_FILENAME.tar.bz2
		_GDCM_DIR=$_PROJECT_PATH/thirdParties/gdcm/generated/$_USER_SPECIFIC/gdcm
		_GDCM_SRC_DIR=$_PROJECT_PATH/thirdParties/gdcm/generated/$_USER_SPECIFIC
	...
	# vtk http://www.vtk.org/
		...
		# _VTK_SOURCE_FILENAME=VTK-8.0.0
